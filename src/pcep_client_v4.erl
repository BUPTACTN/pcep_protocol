...
%%       io:format("LinkMsg_1 in v3 is ~p~n",[Ls_report_link_1_Message]),
  ...
  Ls_report_Message = list_to_binary([Ls_report_nodes_Message,Ls_report_links_1_Message,Ls_report_link_1_Message,Ls_report_link_0_Message]),
